  ...
  return (
    <section className={cn('bg-base-3 relative rounded-2xl p-5 shadow-lg', className)}>
      <div className="flex items-center justify-between gap-4">
        <h2 className="text-base-0 shrink-0 text-base leading-[1.4] font-bold tracking-[-0.4px]">{title}</h2>
        <span className="text-xs leading-[1.4] font-semibold tracking-[-0.3px] whitespace-nowrap text-[#D6D6D6]">
          {badge}
        </span>
      </div>
      {children}
